...
export default function App() {
  ...
  return (
    <div className="bg-[var(--color-obsidian-deep)] font-sans relative selection:bg-[var(--color-champagne-accent)] selection:text-[var(--color-obsidian-deep)]">
      <CustomCursor />

      {/* Act I: The Monolith - Header Entry Animation */}
      <motion.header 
      ...
      >
        <div className="flex justify-between items-center w-full px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] py-[var(--spacing-unit)] max-w-[var(--spacing-max-width)] mx-auto">
          ...
          <div className="hidden md:flex gap-[var(--spacing-gutter)]">
            {['MANIFESTO', 'CURATION', 'NARRATIVE'].map((item, i) => (
              <motion.a 
                ...
                className="font-mono text-[14px] text-[var(--color-on-surface-variant)] hover:text-[var(--color-champagne-accent)] transition-colors duration-700 tracking-[0.1em]" 
          ...
          <motion.button 
            ...
            className="breath-button font-mono text-[14px] text-[var(--color-platinum-white)] border-[0.5px] border-[var(--color-hairline-stroke)] px-6 py-2 hover:text-[var(--color-champagne-accent)] hover:border-[var(--color-champagne-accent)] transition-all duration-700 tracking-[0.1em]"
          >
            Request Access
          </motion.button>
        </div>
      ...
      <main>
        ...
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          >
            <motion.span 
              ...
              className="material-symbols-outlined text-[var(--color-platinum-white)] font-light text-2xl block"
            >
              ↓
            </motion.span>
          </motion.div>
        ...
        <section id="manifesto" className="min-h-screen flex flex-col justify-center px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] py-64 max-w-[var(--spacing-max-width)] mx-auto relative z-10">
        ...
        {/* Act III: The Curation (Cascading Reveal added) */}
        <section id="curation" className="py-32 px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] max-w-[var(--spacing-max-width)] mx-auto relative z-10">
          <FadeUp delay={0.1}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-[var(--spacing-gutter)] items-start">
            {/* Pillar 1 */}
            <FadeUp delay={0.2} yOffset={40} className="md:col-span-4 group border-t border-[var(--color-hairline-stroke)] pt-12 space-y-8 hover:bg-[var(--color-charcoal-core)]/50 transition-colors duration-1000 p-6">
              ...
              <p className="font-sans text-[16px] text-[var(--color-on-surface-variant)] opacity-0 group-hover:opacity-100 transition-opacity duration-1000 font-light leading-[24px]">
            ...
            {/* Pillar 2 */}
            <FadeUp delay={0.4} yOffset={40} className="md:col-span-4 md:mt-32 group border-t border-[var(--color-hairline-stroke)] pt-12 space-y-8 hover:bg-[var(--color-charcoal-core)]/50 transition-colors duration-1000 p-6">
            ...
            {/* Pillar 3 */}
            <FadeUp delay={0.6} yOffset={40} className="md:col-span-4 group border-t border-[var(--color-hairline-stroke)] pt-12 space-y-8 hover:bg-[var(--color-charcoal-core)]/50 transition-colors duration-1000 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <FadeUp delay={0.3} className="space-y-12">
                <div className="group">
                  ...
                  <h4 className="font-serif text-3xl text-[var(--color-platinum-white)] mb-4 tracking-[0.05em] group-hover:text-[var(--color-champagne-accent)] transition-colors duration-1000">The Sovereign Creditor Shift</h4>
                ...
                <div className="group">
                  ...
                  <h4 className="font-serif text-3xl text-[var(--color-platinum-white)] mb-4 tracking-[0.05em] group-hover:text-[var(--color-champagne-accent)] transition-colors duration-1000">The Civilizational Premium</h4>
              ...
              <FadeUp delay={0.5} className="border-[0.5px] border-[var(--color-hairline-stroke)] p-12 bg-[var(--color-obsidian-deep)]/50 space-y-12 backdrop-blur-sm hover:bg-[var(--color-obsidian-deep)]/70 transition-colors duration-1000">
                <div>
                  ...
                  <div className="space-y-8">
                    <div className="flex justify-between items-start border-b border-[var(--color-hairline-stroke)] pb-6 hover:border-[var(--color-champagne-accent)]/30 transition-colors duration-700">
        ...
        {/* Act V: The Gates */}
        <section className="min-h-screen flex items-center justify-center bg-[var(--color-obsidian-deep)] px-[var(--spacing-margin-mobile)] relative z-10">
            ...
            <AnimatePresence mode="wait">
              {ritualStep === 1 && (
                <motion.div 
                  ...
                  className="space-y-8"
                >
                  <div className="border-b border-[var(--color-hairline-stroke)] py-4 text-left group">
                    <label className="font-sans font-bold text-[12px] text-[var(--color-on-tertiary-container)] group-focus-within:text-[var(--color-champagne-accent)] block mb-2 tracking-[0.15em] uppercase transition-colors duration-500">IDENTIFIER</label>
                  ...
                  <button 
                    ...
                    className="breath-button w-full py-6 font-mono text-[14px] tracking-[0.1em] text-[var(--color-platinum-white)] border-[0.5px] border-[var(--color-hairline-stroke)] hover:bg-[var(--color-platinum-white)] hover:text-[var(--color-obsidian-deep)] hover:border-[var(--color-platinum-white)] transition-all duration-700 uppercase"
                  >
                    PROCEED
                  </button>
                </motion.div>
              ...
              {ritualStep === 2 && (
                ...
                >
                  <div className="border-b border-[var(--color-hairline-stroke)] py-4 text-left group">
                    <label className="font-sans font-bold text-[12px] text-[var(--color-on-tertiary-container)] group-focus-within:text-[var(--color-champagne-accent)] block mb-2 tracking-[0.15em] uppercase transition-colors duration-500">DOMAIN</label>
      ...
      <footer className="bg-[var(--color-obsidian-deep)] border-t border-[var(--color-hairline-stroke)] relative z-10">
        <div className="w-full px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] py-12 max-w-[var(--spacing-max-width)] mx-auto flex flex-col md:flex-row justify-between gap-[var(--spacing-gutter)]">
          ...
          <div className="grid grid-cols-2 md:flex gap-12">
            <div className="flex flex-col gap-2">
              ...
              <a className="font-mono text-[14px] tracking-[0.1em] text-[var(--color-on-surface-variant)] hover:text-[var(--color-champagne-accent)] transition-colors duration-500" href="#">VAULT</a>
              <a className="font-mono text-[14px] tracking-[0.1em] text-[var(--color-on-surface-variant)] hover:text-[var(--color-champagne-accent)] transition-colors duration-500" href="#">LEDGER</a>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <a className="font-mono text-[14px] tracking-[0.1em] text-[var(--color-on-surface-variant)] hover:text-[var(--color-champagne-accent)] transition-colors duration-500" href="#">LEGAL</a>
              <a className="font-mono text-[14px] tracking-[0.1em] text-[var(--color-on-surface-variant)] hover:text-[var(--color-champagne-accent)] transition-colors duration-500" href="#">PRIVACY</a>
            </div>
          </div>
